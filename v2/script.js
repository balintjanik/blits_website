...
window.onload = function(){
    ...
    for (let i = 0; i < contactitems.length; i++){
        contactitems[i].addEventListener("click", (e) => {
            ...
            navigator.clipboard.writeText(contactitems[i].childNodes[3].childNodes[0].innerText).then(function() {
        ...
        for(let i = 0; i < numberOfParticles; i++){
            ...
            switch(rnd){
                case 0:
                    ...
                    color = 'rgba( 0, 232, 226, 0.2)'
                    break;
                case 1:
                    //color = 'rgba(221, 240, 247, 0.7)';
                    color = 'rgba( 0, 232, 226, 0.1)'
                    break;
                case 2:
                    //color = 'rgba(240, 247, 253, 0.9)';
                    color = 'rgba( 0, 232, 226, 0.05)'
                    break;
            }
